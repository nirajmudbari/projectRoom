...
<body>
		...
		<nav
			...
			<div>
				...
				<p style="margin-right: -10px;">
					you are logged in as: <%=session.getAttribute("user_email") %>
					&nbsp &nbsp &nbsp &nbsp 
				</p></div><div>
						<a 
						class="btn btn-info btn-lg d-flex justify-content-center align-items-center align-content-center align-self-center mr-sm-2"
						role="button" href="/projectRoom/logout.do"> LogOut</a>			
						</div>

		</nav>
	</div>
	<div id="promo"
		style="text-align: center; padding: 100px; margin-top: 7px; background-color: #D358F7;; no-repeat; background-size: cover;">
		...
		<div class="container site-section" id="welcome"
			...
			<p
				style="font-size: 40px; color: white; font-weight: bold; font-family: Bookman Old Style;">FIND
				YOUR IDEAL ROOM FOR RENT</p>
			<div class="nav-wrapper"></div>

			<div class="input-field">
				<br>

				<p style="font-size: 30px; color: #edf3ff; font-family: rockwell;">Looking
					For a Room?</p>
				<br>


				<form action="searchone.html" method="POST">

					<div class="input-field">

						<input id="chartst" type="search" placeholder=""> <label
							class="label-icon" for="search"></label> <input type="submit"
							value="Search" onclick=" return charValidate();"></input>
					</div>
  ...
  if (chartest.value == "") {
    ...
    return true;
		...
		<div>
			<p style="font-size: 30px; color: #edf3ff; font-family: rockwell;">
				Do You Want To Add Room <a href="post.jsp" style="hover: none">Click
					Here!</a>
			</p>
		</div>
		...
		<div class="container site-section" id="how">
			...
			<div class="row" style="font-size: 42px;">
				<div class="col-4">
					...
					<p style="font-size: 20px; font-style: bold;">We manually check
						every room on Room Finder to keep you safe. Find your perfect room
						and enjoy.</p>
				</div>
				...
				<div class="col-4">
					...
					<p style="font-size: 20px; font-style: bold;">Search the best
						availbale rooms in your prefered location.</p>
				</div>
			</div>
		</div>
	</div>
