	...
	<div class="container">
		<nav
			...
			<div class="collapse navbar-collapse" id="navcol-1">
				...
				<a href="login.jsp">
					<button class="btn btn-light btn-lg action-button" id="login"
						type="button" data-bs-hover-animate="pulse" data-toggle="modal"
						data-target="#exampleModal">Log In</button>
				</a> <a href="signup.jsp"><button
						class="btn btn-light btn-lg action-button" id="signupbtn"
						type="button" data-bs-hover-animate="pulse" data-toggle="modal"
						data-target="#signupModal">Sign Up</button></a>
				...
				<form action="search.jsp" method="POST">
					...
					<div class="input-field">
						...
						<input id="chartst" type="search" placeholder=""> <label
							class="label-icon" for="search"></label><a href="search.jsp"> <input type="submit"
							value="Search" onclick=" return charValidate();"></input></a>
					</div>
